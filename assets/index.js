...
(function($PS) {
  ...
  var WsURL = function (x) {
      return x;
  };
  var newtypeWsURL = new Data_Newtype.Newtype(function (n) {
      return n;
  }, WsURL);
  exports["newtypeWsURL"] = newtypeWsURL;
})(PS);
(function(exports) {
...
(function($PS) {
  ...
  var Heterogeneous_Mapping = $PS["Heterogeneous.Mapping"];
  var UI = $PS["UI"];                
  var ArticleForm = function (x) {
      return x;
  };
  var HandleArticleForm = (function () {
      function HandleArticleForm(value0) {
          this.value0 = value0;
      };
      HandleArticleForm.create = function (value0) {
          return new HandleArticleForm(value0);
      };
      return HandleArticleForm;
  })();
  var someFixedWidth = 600;
  var someFixedHeight = 200;
  ...
  var formComponent = function (dictMonadAff) {
      var renderFormless = function (v) {
          return Halogen_HTML_Elements.div([ UI.css("field") ])([ Halogen_HTML_Elements.form_([ Halogen_HTML_Elements.h1([ UI.css("title") ])([ Halogen_HTML_Core.text("Enter a twitch clip") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "clipUrl";
          }))(newtypeLoginForm)()(Data_Symbol.SProxy.value)(v.form)), UI.css("input"), Halogen_HTML_Events.onValueInput((function () {
              var $21 = Formless_Action.set(new Data_Symbol.IsSymbol(function () {
                  return "clipUrl";
              }))(newtypeLoginForm)()(Data_Symbol.SProxy.value);
              return function ($22) {
                  return Data_Maybe.Just.create($21($22));
              };
          })()), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputUrl.value) ]), Halogen_HTML_Elements.h1([ UI.css("title") ])([ Halogen_HTML_Core.text("Enter a title") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "title";
          }))(newtypeLoginForm)()(Data_Symbol.SProxy.value)(v.form)), UI.css("input"), Halogen_HTML_Events.onValueInput((function () {
              var $23 = Formless_Action.set(new Data_Symbol.IsSymbol(function () {
                  return "title";
              }))(newtypeLoginForm)()(Data_Symbol.SProxy.value);
              return function ($24) {
                  return Data_Maybe.Just.create($23($24));
              };
          })()) ]), Halogen_HTML_Elements.button([ UI.css("button is-link"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropButtonType)(DOM_HTML_Indexed_ButtonType.ButtonSubmit.value), Halogen_HTML_Events.onClick(function (v1) {
      ...
      var formInput = function (v) {
          return {
              ...
              validators: {
                  clipUrl: Formless_Validation.noValidation((dictMonadAff.MonadEffect0()).Monad0()),
                  title: Formless_Validation.noValidation((dictMonadAff.MonadEffect0()).Monad0())
              }
          };
      };
  ...
  var renderClip = function (dictMonadAff) {
      return function (st) {
          if (st.shouldRenderClip) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.iframe([ Halogen_HTML_Properties.src(st.clip), Halogen_HTML_Properties.width(someFixedWidth), Halogen_HTML_Properties.height(someFixedHeight) ]) ]);
          };
          return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "formless";
          }))(Data_Ord.ordUnit)(Formless_Types_Component["_formless"])(Data_Unit.unit)(formComponent(dictMonadAff))(Data_Unit.unit)(function ($25) {
              return Data_Maybe.Just.create(HandleArticleForm.create($25));
          });
      };
  };
  var component = function (dictMonadAff) {
      var render = function (st) {
          return Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("Oi M8"), renderClip(dictMonadAff)(st) ]);
      };
      var initialState = Data_Function["const"]({
          clip: "",
          shouldRenderClip: false
      });
      var handleAction = function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Data_Show.show(Data_Show.showString)(v.value0.clipUrl)))(function () {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $17.clip = v.value0.clipUrl;
                  $17.shouldRenderClip = true;
                  return $17;
              });
          });
      };
...
(function($PS) {
  ...
  var genericRoutes = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Data.Route (line 19, column 1 - line 19, column 49): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var router = Routing_Duplex.root(Routing_Duplex_Generic.sum(genericRoutes)(Routing_Duplex_Generic.gRouteSum(Routing_Duplex_Generic.gRouteConstructor(new Data_Symbol.IsSymbol(function () {
      ...
      Button: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("button")(Routing_Duplex_Generic.noArgs),
      Article: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("article")(Routing_Duplex_Generic.noArgs),
      ...
      Question: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("question")(Routing_Duplex_Generic.noArgs)
  }));
  var showRoutes = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericRoutes)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
      return "Login";
  ...
  var eqRoute = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof Article && y instanceof Article) {
              return true;
          };
          if (x instanceof Register && y instanceof Register) {
              return true;
          };
          if (x instanceof Question && y instanceof Question) {
              return true;
          };
          return false;
      };
...
(function($PS) {
  ...
  var hello = new ToText(function (v) {
      ...
      throw new Error("Failed pattern match at Validation (line 47, column 1 - line 51, column 46): " + [ v.constructor.name ]);
  });
...
(function($PS) {
  ...
  var formComponent = function (dictMonadAff) {
      var renderFormless = function (v) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("field") ])([ Halogen_HTML_Elements.form_([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("field") ])([ Halogen_HTML_Core.text("Email") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "loginRequestName";
          }))(newtypeLoginForm)()(Data_Symbol.SProxy.value)(v.form)), Halogen_HTML_Events.onValueInput((function () {
          ...
          })()), Halogen_HTML_Properties.class_("input") ]), Halogen_HTML_Core.text((function () {
              ...
              if (v1 instanceof Data_Maybe.Just && v1.value0 instanceof Validation.InvalidEmail) {
                  return Validation.toText(Validation.hello)(Validation.InvalidEmail.value);
              };
              if (v1 instanceof Data_Maybe.Just) {
                  return "Invalid.";
              };
              throw new Error("Failed pattern match at Login (line 113, column 18 - line 116, column 31): " + [ v1.constructor.name ]);
          })()), Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("field") ])([ Halogen_HTML_Core.text("Password") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
          ...
          })()), Halogen_HTML_Properties.class_("input"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputPassword.value) ]) ]), Halogen_HTML_Core.text((function () {
              var v1 = Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "loginRequestPassword";
              }))(newtypeLoginForm)()(Data_Symbol.SProxy.value)(v.form);
              if (v1 instanceof Data_Maybe.Nothing) {
              ...
              if (v1 instanceof Data_Maybe.Just && v1.value0 instanceof Validation.TooShort) {
                  return Validation.toText(Validation.hello)(new Validation.TooShort(v1.value0.value0));
              };
              if (v1 instanceof Data_Maybe.Just) {
                  return "Invalid.";
              };
              throw new Error("Failed pattern match at Login (line 128, column 17 - line 131, column 30): " + [ v1.constructor.name ]);
          })()), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("button is-link"), Halogen_HTML_Events.onClick(function (v1) {
              return new Data_Maybe.Just(Formless_Action.submit);
          }), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropButtonType)(DOM_HTML_Indexed_ButtonType.ButtonSubmit.value) ])([ Halogen_HTML_Core.text("Submit") ]), (function () {
              if (v.loginError) {
                  return Halogen_HTML_Core.text("Invalid email or password.");
              };
              if (!v.loginError) {
                  return Halogen_HTML_Core.text("");
              };
              throw new Error("Failed pattern match at Login (line 138, column 9 - line 140, column 30): " + [ v.loginError.constructor.name ]);
          })(), Halogen_HTML_Core.text(Data_Show.show(Data_Show.showBoolean)(v.loginError)) ]);
      };
      ...
      var formInput = function (v) {
          return {
              initialInputs: Data_Maybe.Nothing.value,
              validators: {
                  loginRequestName: Formless_Validation.noValidation((dictMonadAff.MonadEffect0()).Monad0()),
                  loginRequestPassword: Formless_Validation.noValidation((dictMonadAff.MonadEffect0()).Monad0())
              },
              loginError: false
          };
      };
  ...
  var component = function (dictMonadAff) {
      var render = function (st) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("field") ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.title("Login") ])([ Halogen_HTML_Core.text("Login") ]), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "formless";
          }))(Data_Ord.ordUnit)(Formless_Types_Component["_formless"])(Data_Unit.unit)(formComponent(dictMonadAff))(Data_Unit.unit)(function ($54) {
              return Data_Maybe.Just.create(HandleLoginAction.create($54));
          }) ]);
      };
      var initialState = Data_Function["const"]({
      ...
      var handleAction = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Affjax.request({
              ...
              content: new Data_Maybe.Just(Affjax_RequestBody.json(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                  return "loginRequestPassword";
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $42.invalidCredentials = true;
                  return $42;
              }))(function () {
                  if (res instanceof Data_Either.Left) {
                      return Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Affjax.printError(res.value0));
                  };
                  if (res instanceof Data_Either.Right) {
                      if (res.value0.status === 500) {
                      ...
                      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                          return "formless";
                      }))(Data_Ord.ordUnit)(Formless_Types_Component["_formless"])(Data_Unit.unit)(Formless_Query.injQuery(functorQuery)(new CredError(false, Data_Unit.unit))));
                  };
                  throw new Error("Failed pattern match at Login (line 73, column 12 - line 78, column 103): " + [ res.constructor.name ]);
              });
          });
      };
      return Halogen_Component.mkComponent({
...
(function($PS) {
  ...
  var formComponent = function (dictMonadAff) {
      var renderFormless = function (v) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("field") ])([ Halogen_HTML_Elements.form_([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("field") ])([ Halogen_HTML_Core.text("Question") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "questionBody";
          }))(newtypeQuestionForm)()(Data_Symbol.SProxy.value)(v.form)), Halogen_HTML_Events.onValueInput((function () {
              var $32 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                  return "questionBody";
              }))(newtypeQuestionForm)()(Data_Symbol.SProxy.value);
              return function ($33) {
              ...
              var v1 = Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "questionBody";
              }))(newtypeQuestionForm)()(Data_Symbol.SProxy.value)(v.form);
              if (v1 instanceof Data_Maybe.Nothing) {
                  return "";
              };
              if (v1 instanceof Data_Maybe.Just && v1.value0 instanceof Validation.TooShort) {
              ...
              throw new Error("Failed pattern match at Question (line 127, column 17 - line 130, column 30): " + [ v1.constructor.name ]);
          })()), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("button is-link"), Halogen_HTML_Events.onClick(function (v1) {
              return new Data_Maybe.Just(Formless_Action.submit);
      ...
      var formInput = function (v) {
          return {
              initialInputs: Data_Maybe.Nothing.value,
              validators: {
                  questionBody: Formless_Validation.noValidation((dictMonadAff.MonadEffect0()).Monad0())
              }
          };
      };
  ...
  var component = function (dictMonadAff) {
      var render = function (st) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("field") ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.title("Question") ])([ Halogen_HTML_Core.text("Question") ]), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "formless";
          }))(Data_Ord.ordUnit)(Formless_Types_Component["_formless"])(Data_Unit.unit)(formComponent(dictMonadAff))(Data_Unit.unit)(function ($34) {
              return Data_Maybe.Just.create(HandleQuestionAction.create($34));
          }) ]);
      };
      var initialState = Data_Function["const"]({
          invalidCredentials: false
      ...
      var handleAction = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Affjax.request({
              ...
              headers: Affjax.defaultRequest.headers,
              content: new Data_Maybe.Just(Affjax_RequestBody.json(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                  return "questionBody";
              }))())())(v.value0))),
              username: Affjax.defaultRequest.username,
              password: Affjax.defaultRequest.password,
              ...
              throw new Error("Failed pattern match at Question (line 77, column 12 - line 81, column 116): " + [ res.constructor.name ]);
          });
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
...
(function($PS) {
  ...
  var formComponent = function (dictMonadAff) {
      var renderFormless = function (v) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("field") ])([ Halogen_HTML_Elements.form_([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("field") ])([ Halogen_HTML_Core.text("Name") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "loginRequestName";
          }))(newtypeRegisterForm)()(Data_Symbol.SProxy.value)(v.form)), Halogen_HTML_Events.onValueInput((function () {
              var $41 = Formless_Action.set(new Data_Symbol.IsSymbol(function () {
                  return "loginRequestName";
              }))(newtypeRegisterForm)()(Data_Symbol.SProxy.value);
              return function ($42) {
                  return Data_Maybe.Just.create($41($42));
              };
          })()), UI.css("input"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value) ]), Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("field") ])([ Halogen_HTML_Core.text("Password") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "loginRequestPassword";
          }))(newtypeRegisterForm)()(Data_Symbol.SProxy.value)(v.form)), Halogen_HTML_Events.onValueInput((function () {
              var $43 = Formless_Action.set(new Data_Symbol.IsSymbol(function () {
                  return "loginRequestPassword";
              }))(newtypeRegisterForm)()(Data_Symbol.SProxy.value);
              return function ($44) {
                  return Data_Maybe.Just.create($43($44));
              };
          })()), UI.css("input"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputPassword.value) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("button is-link"), Halogen_HTML_Events.onClick(function (v1) {
              return new Data_Maybe.Just(Formless_Action.submit);
          }), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropButtonType)(DOM_HTML_Indexed_ButtonType.ButtonSubmit.value) ])([ Halogen_HTML_Core.text("Submit") ]), (function () {
              if (v.loginError) {
                  return Halogen_HTML_Core.text("Invalid email or password.");
              ...
              throw new Error("Failed pattern match at Register (line 139, column 11 - line 141, column 32): " + [ v.loginError.constructor.name ]);
          })() ]) ]);
      };
      var handleQuery = function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
  ...
  var component = function (dictMonadAff) {
      var render = function (st) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("field") ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.title("Login") ])([ Halogen_HTML_Core.text("Login") ]), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "formless";
          }))(Data_Ord.ordUnit)(Formless_Types_Component["_formless"])(Data_Unit.unit)(formComponent(dictMonadAff))(Data_Unit.unit)(function ($45) {
              return Data_Maybe.Just.create(HandleRegisterAction.create($45));
          }) ]);
      };
      var initialState = Data_Function["const"]({
          invalidCredentials: false
      ...
      var handleAction = function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("hi")))(function () {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Affjax.request({
                  method: new Data_Either.Left(Data_HTTP_Method.POST.value),
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      throw new Error("Failed pattern match at Register (line 73, column 12 - line 77, column 101): " + [ res.constructor.name ]);
                  });
              });
          });
      };
...
(function($PS) {
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Login = $PS["Login"];
  var Question = $PS["Question"];
  var Register = $PS["Register"];
  var UI = $PS["UI"];                
  var GoTo = (function () {
  ...
  var component = function (dictMonadAff) {
      var link = function (s) {
          return Halogen_HTML_Elements.a([ UI.css("navbar-item"), Halogen_HTML_Properties.href("/#/" + Data_String_Common.toLower(Data_Show.show(Data_Route.showRoutes)(s))) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Route.showRoutes)(s) + " ") ]);
      };
      var render = function (st) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.nav([ UI.css("navbar is-primary") ])([ Halogen_HTML_Elements.div([ UI.css("navbar-brand") ])(Data_Functor.map(Data_Functor.functorArray)(link)([ Data_Route.Login.value, Data_Route.Article.value, Data_Route.Register.value, Data_Route.Question.value ])) ]), (function () {
              if (st.currentPage instanceof Data_Maybe.Just && st.currentPage.value0 instanceof Data_Route.Login) {
                  return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                      return "login";
                  }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Login.component(dictMonadAff))(Data_Unit.unit)(function (v) {
                      return Data_Maybe.Nothing.value;
                  });
              };
              if (st.currentPage instanceof Data_Maybe.Just && st.currentPage.value0 instanceof Data_Route.Article) {
                  return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                      return "article";
                  }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Article.component(dictMonadAff))(Data_Unit.unit)(function (v) {
                      return Data_Maybe.Nothing.value;
                  });
              };
              if (st.currentPage instanceof Data_Maybe.Just && st.currentPage.value0 instanceof Data_Route.Register) {
                  return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                      return "register";
                  }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Register.component(dictMonadAff))(Data_Unit.unit)(function (v) {
                      return Data_Maybe.Nothing.value;
                  });
              };
              if (st.currentPage instanceof Data_Maybe.Just && st.currentPage.value0 instanceof Data_Route.Question) {
                  return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                      return "question";
                  }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Question.component(dictMonadAff))(Data_Unit.unit)(function (v) {
                      return Data_Maybe.Nothing.value;
                  });
              };
      ...
      var handleQuery = function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $18.currentPage = new Data_Maybe.Just(v.value0);
              return $18;
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
          });
          ...
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Aff_Bus.make(Effect_Class.monadEffectEffect)))(function (userBus) {
              var environment = (function () {
                  ...
                  return {
                      ...
                      userEnv: userEnv,
                      wsUrl: "ws://localhost:8000/lobby/join"
                  };
              })();
              var rootComponent = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(AppM.runAppM(environment))(Router.component(AppM.monadAffAppM));
              return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(rootComponent)({
                  currentPage: Data_Maybe.Nothing.value
              })(body))(function (driver) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_Hash.matchesWith(Data_Either.foldableEither)(Routing_Duplex.parse(Data_Route.router))(function (old) {
                      return function ($$new) {
                          return Control_Applicative.when(Effect.applicativeEffect)(Data_Eq.notEq(Data_Maybe.eqMaybe(Data_Route.eqRoute))(old)(new Data_Maybe.Just($$new)))(Effect_Aff.launchAff_(driver.query(Halogen_Query.tell(Router.GoTo.create($$new)))));
                      };
                  }))))(function () {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(WebSocket.newWebSocket(WebSocket.URL(Data_Newtype.unwrap(API_Request.newtypeWsURL)("ws://localhost:8000/lobby/join")))([  ])))(function (v) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Var.set(Effect_Var.settableSettableVar)(v.onopen)(function (event) {
                              return Effect_Console.log("onopen: Connection opened");
                          })))(function () {
